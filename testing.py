...
for i in range(1, 4):
    ...
    net.SGD(training_data, 30, 10, 3.0, test_data=test_data, reg="L1", lmbda=5.0)
...
for i in range(1, 4):
    ...
    print("")
    net = nn.Network([784, 30, 10], nn.CrossEntropyCost)
    net.SGD(training_data, 30, 10, 0.5, test_data=test_data, reg="L1", lmbda=5.0)
...
# net.SGD(training_data, 60, 10, 3.0, test_data=test_data, reg="L2", lmbda=5.0)

# print("Cross Entropy CF with 100 hidden neurons and L2 regularization")
# net = nn.Network([784, 100, 10], nn.CrossEntropyCost)
# net.SGD(training_data, 60, 10, 0.5, test_data=test_data, reg="L2", lmbda=5.0)
